...
(function(jQuery){
	...
	jQuery.fn.contactable = function(options) {
		...
		var defaults = {
			...
			submit : 'SEND',
			recievedMsg : 'Thank you for contacting us',
			notRecievedMsg : 'Thank you for contacting us',
		...
		return this.each(function() {
			...
			*/
			...
			jQuery(this).html('<div id="contactable-inner"></div><form id="contactable-contactForm" method="" action=""><div id="contactable-loading"></div><div id="contactable-callback"></div><div class="contactable-holder"><p class="contactable-header">'+options.header+'</p><p><label for="contactable-name">'+options.name+'<span class="contactable-green"> * </span></label><br /><input id="contactable-name" class="contactable-contact contactable-validate" name="name" /></p><p><label for="contactable-email">'+options.email+' <span class="contactable-green"> * </span></label><br /><input id="contactable-email" class="contactable-contact contactable-validate" name="email" /></p><p><label for="contactable-mobile">'+options.mobile+'<span class="contactable-green"> * </span></label><br /><input id="contactable-mobile" class="contactable-contact contactable-validate" name="mobile" /></p><p><label for="contactable-message">'+options.message+' <span class="contactable-green"> * </span></label><br /><textarea id="contactable-message" name="message" class="contactable-message contactable-validate" rows="4" cols="30" ></textarea></p><p><input class="contactable-submit" type="submit" value="'+options.submit+'"/></p><p class="contactable-footer">'+options.footer+'</p></div></form>');
			...
			function submitForm() {
				...
				jQuery.ajax({
					...
					data: {
						...
						mobile:jQuery('#contactable-mobile').val(),
