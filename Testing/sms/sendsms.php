...
//send SMS to patient
       echo "Your messege has been sent will be delievered soon.";
        $curl = curl_init();
        $timeout = 30;
        $result = array();
        $ReciverMobile = '8796154725'; // Reciver Mobile Number
        $uid = urlencode('8796154725'); //Way2sms Userid
        $pwd = urlencode('123456'); //Way2sms login Password
        $msg = 'YOUR MESSAGE ';
        $autobalancer = 23;
        // Setup for login
