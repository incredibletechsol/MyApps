...
$post_data = array(
    ...
    'bizType' => 'refundApply',//default value without modify
    'version' => '2.1',//default value without modify
    'refundId' => 'test_456',//change to your own refund order id
    'orderId' => 'test_123',//change to your own order id
    'amount' => '88.88',//change to the refund transaction amount
    'currency' => 'INR',//change to the refund transaction currency code
    'callbackUrl' => 'https://test3.com',//change to your own refund server callback url
    'comment' => 'refund for sale',//change to your own refund reason or remark
);
