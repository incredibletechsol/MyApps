					...
					<div class="row">
						<div class="col-lg-12">
							...
							if(isset($_GET['msg'])) 
								...
								if($param=="sentzip")
									 echo "<div id='SUCCESS'><div class='alert alert-success'><i class='fa fa-check-circle fa-fw fa-lg'></i><strong>All PDF's Sent on your Email</strong></div></div>";		 
								}
							?>
							<div align="right">	
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg"><i class="fa fa-plus-circle fa-lg"></i>Add Document</a>
								<a data-toggle="modal" href="mypdfdocsactions.php?msg=sendzip" class="btn btn-primary btn-lg"><i class="fa fa-lg"></i>Send All PDF's(.zip)</a>
							</div>	
						</div>
					</div>
								...
								<div class="main-box-body clearfix">
									<div class="table-responsive">
										<?php
										 	$db = new Database();
											$db->connect();
											$db->sql("select * from tbl_mypdfdocs order by id desc"); 
											$rs = $db->getResult();
												...
												foreach($rs as $x) 
													...
													$i++;	
													 echo "<tr>";  
														 $id=$x['id'];
														 echo  "<td>". $i."</td>";
														 echo  "<td><a href='mypdfdocs/$x[pdffilename]' target='_blank'><b>". $x['docname']."</b></a></td>";
														 echo  "<td><a href='mypdfdocsactions.php?name=$x[pdffilename]&msg=sendonemail'><img src='img/email.png'></a></td>";
														 echo  "<td><a href='mypdfdocsactions.php?id=$id&msg=deletepdfdoc'><img src='img/cross.png'></a></td>";
													echo "</tr>"; 
													}
											echo "</tbody>";  
											echo "</table>";
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form name="pdfdoc" method="post" action="mypdfdocsactions.php" onSubmit="return checkInput(this)"  enctype="multipart/form-data">
					<script>
